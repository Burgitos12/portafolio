...
const skillsData = [
  { name: 'React', icon: <FaReact size={40} />, level: 10, color: 'text-blue-400', barColor: 'bg-blue-400' },
  { name: 'JavaScript', icon: <FaJs size={40} />, level: 10, color: 'text-yellow-400', barColor: 'bg-yellow-400' },
  { name: 'Tailwind CSS', icon: <SiTailwindcss size={40} />, level: 50, color: 'text-cyan-400', barColor: 'bg-cyan-400' },
  { name: 'HTML5', icon: <FaHtml5 size={40} />, level: 80, color: 'text-orange-500', barColor: 'bg-orange-500' },
  { name: 'CSS3', icon: <FaCss3Alt size={40} />, level: 60, color: 'text-blue-500', barColor: 'bg-blue-500' },
  { name: 'Node.js', icon: <FaNodeJs size={40} />, level: 10, color: 'text-green-500', barColor: 'bg-green-500' },
  { name: 'Git', icon: <FaGitAlt size={40} />, level: 20, color: 'text-red-500', barColor: 'bg-red-500' },
];
