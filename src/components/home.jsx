...
const Home = () => {
  ...
  return (
    <section id="inicio" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20">
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent">
            Hola, soy <span className="text-white">Stiven Burgos</span>
          </h1>
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-8">
            <motion.a
              href="https://github.com/Burgitos12?tab=repositories"
              target="_blank"
